...
# Create cpp_modules directory
os.makedirs('cpp_modules', exist_ok=True)
print("Created cpp_modules directory")

# Create processor.cpp file
processor_cpp_content = '''#include <string>
#include <vector>
#include <algorithm>
#include <sstream>
#include <cctype>
...
with open('cpp_modules/processor.cpp', 'w') as f:
    f.write(processor_cpp_content)

print("Created cpp_modules/processor.cpp")
